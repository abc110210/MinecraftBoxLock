...
public class MessageUtil {
	...
	private static String getHardcodedMessage(String key) {
		switch (key) {
			// 放置箱子
			case "PlacePriBox": return "&a[&e寄寄之家&a] &6你放置了一个 &c私有 &6的箱子";
			case "PlacePubBox": return "&a[&e寄寄之家&a] &6你放置了一个 &a公开 &6的箱子";
			// 独立权限
			case "Individualadd": return "&a[&e寄寄之家&a] &6成功对玩家 &b{player} &6添加该箱子权限";
			case "IndividualRemove": return "&a[&e寄寄之家&a] &6已取消玩家 &b{player} &6对该箱子权限";
			// 全局权限
			case "Globaladd": return "&a[&e寄寄之家&a] &6成功授权玩家 &b{player} &6所有箱子的权限";
			case "GlobalRemove": return "&a[&e寄寄之家&a] &6取消玩家 &b{player} 所有箱子授权权限";
			// 锁定开关
			case "LockEnable": return "&a[&e寄寄之家&a] &6已将箱子切换为 &a公开 &6状态";
			case "LockDisable": return "&a[&e寄寄之家&a] &6已将箱子切换为 &c私有 &6状态";
			// 漏斗开关
			...
			case "PasswordBoxClear": return "&a[&e寄寄之家&a] &c已清除该箱子的密码保护";
			...
			// 默认状态箱子放置
			case "DefaultPlacePrivate": return "&a[&e寄寄之家&a] &6已将新放置的容器默认设置为 &c私有 &6状态";
			case "DefaultPlacePublic": return "&a[&e寄寄之家&a] &6已将新放置的容器默认设置为 &a公开 &6状态";
			// 默认状态漏斗传输
			...
			// 破坏箱子和打开箱子
			case "PrivateBreak": return "&a[&e寄寄之家&a] &6这个箱子是 &a公开 &6状态，你无法破坏,只能打开";
			case "LockBox": return "&a[&e寄寄之家&a] &c这个箱子已被上锁，当前无法打开!";
			case "LockBreak": return "&a[&e寄寄之家&a] &c这个箱子已被上锁，当前无法破坏!";
			// 指令提示
			...
			case "CommandUsageXlrDesc": return "&a[&e寄寄之家&a] &6将你所有箱子全局授权给指定玩家(包括新放置箱子)";
			...
			case "CommandGlobalAddSuccess": return "&a[&e寄寄之家&a] &6成功将你所有箱子，全局授权于玩家 &b{player}";
